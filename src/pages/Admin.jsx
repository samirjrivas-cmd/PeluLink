    ...
    <div className="min-h-screen bg-[#070707] text-white font-sans p-4 md:p-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-800 pb-5">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-wide text-[#fcfcfc]">Panel de Administración</h1>
            <p className="text-[#D4AF37] text-xs font-semibold uppercase tracking-widest mt-1.5">Gestión de Reservas y Clientes</p>
          </div>
